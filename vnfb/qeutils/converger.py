...
"""
Converger - class that performs convergence tests. 

Notes:
    - Adapted from QECalc Converger class to address remote jobs launching
    - Performs convergence tests according to the following parameters:
        total-energy
        fermi-energy
        frequency
"""
...
__date__ = "$Apr 23, 2010 11:13:37 AM$"
